...
ALTER TABLE revisoes DROP CONSTRAINT pk_revisoes_data_hora_marcacao_matricula;
...
ALTER TABLE revisoes ADD CONSTRAINT uk_revisoes_data_hora_marcacao_matricula UNIQUE(matricula, data_hora_marcacao);
